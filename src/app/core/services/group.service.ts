...
export class GroupService {
  private readonly baseUrl = 'https://localhost:7026/api/groups';
  ...
  assignTeacher(dto: AssignTeacherGroupDto): Observable<any> {
    return this.http.post(`${this.baseUrl}/assign-teacher`, dto);
  }
}
